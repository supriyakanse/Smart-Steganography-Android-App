...
import android.graphics.Bitmap;  //required for bitmap at line 44 and 50
import android.graphics.Canvas;   //required for canvas.drawBitmap line 123 and 131
import android.graphics.Paint;    //required for creating object of paint class at 131
import android.util.Log;

import java.util.ArrayList;         //imported for arraylist used at various place
import java.util.List;              //imported for list created
...
public class Utility {
    ...
    public static Bitmap mergeImage(List<Bitmap> images, int original_height, int original_width) {
        ...
        Bitmap bitmap = Bitmap.createBitmap(original_width, original_height, Bitmap.Config.ARGB_4444); //bitmap possible configs (how pixels are stored)
